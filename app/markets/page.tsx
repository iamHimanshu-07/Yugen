...
export default async function MarketsPage() {
  ...
  const items = catalog.map((coin) => {
    ...
    return {
      ...
      priceChangePercentage7d: cg?.priceChangePercentage7d ?? null,
      priceChangePercentage30d: cg?.priceChangePercentage30d ?? null,
      priceChangePercentage1y: cg?.priceChangePercentage1y ?? null,
