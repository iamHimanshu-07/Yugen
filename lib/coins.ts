...
export const COINS: Record<string, Coin> = {
  ...
  WBT:  { symbol: "WBT",  name: "WhiteBIT",   glyph: "⚪",  color: "#FFFFFF", coingeckoId: "whitebit-coin", decimals: 4, kind: "l1" },
  ...
  CC:   { symbol: "CC",   name: "Canton",    glyph: "💠",  color: "#C0C0C0", coingeckoId: "canton",        decimals: 4, kind: "l1" },
  DAI:  { symbol: "DAI",  name: "Dai",       glyph: "◈",  color: "#F5B8B1", coingeckoId: "dai",           decimals: 4, kind: "stable" },
  USD1: { symbol: "USD1", name: "USD1",      glyph: "$",  color: "#2775CA", coingeckoId: "usd1",          decimals: 4, kind: "stable" },
  USDE: { symbol: "USDE", name: "Ethena USDe", glyph: "⧫", color: "#9B59B6", coingeckoId: "ethena-usde",   decimals: 4, kind: "stable" },
  GRAM: { symbol: "GRAM", name: "Gram",       glyph: "💎",  color: "#B8860B", coingeckoId: "gram",         decimals: 4, kind: "l1" },
};
